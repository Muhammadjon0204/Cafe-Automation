...
// See admin-app's KitchenPage.tsx — this is the same board, running as its own
// standalone app so a Kitchen login lands directly here instead of inside the
// full admin shell. Keep the two in sync by hand if either changes.
