...
// ['tables', ...] / ['orders', ...] prefixes — see OrdersPage.tsx's BOARD_QUERY_KEY
// comment for why, same reasoning here for AppShell's realtime invalidation.
...
export function WaiterPage() {
  ...
  // Realtime hub (AppShell) is the primary update path for both queries below — the
  ...
  return (
    <div className="waiter-page">
      ...
      {rows.length === 0 ? (
        <p className="dashboard-empty">Столов пока нет.</p>
      ) : (
        <div className="waiter-grid">
