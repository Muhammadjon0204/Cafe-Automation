...
// ['orders', ...] / ['tables', ...] prefix convention as admin-app's
// AppShell so WaiterPage's queries pick up live invalidation automatically.
  ...
  return (
    <div className="shell">
      <header className="shell-topbar">
        <span className="shell-brand">AMBRE Waiter</span>
