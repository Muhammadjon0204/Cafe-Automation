        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FiredDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IngredientsDescription = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    IsAvailable = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    IsSeasonal = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    CafeTableId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_CafeTables_CafeTableId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<int>(type: "integer", nullable: false),
                    CustomerId = table.Column<int>(type: "integer", nullable: true),
                    CafeTableId = table.Column<int>(type: "integer", nullable: true),
                    WaiterId = table.Column<int>(type: "integer", nullable: true),
                    CreatedByStaffMemberId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_StaffMembers_CreatedByStaffMemberId",
                        column: x => x.CreatedByStaffMemberId,
                        principalTable: "StaffMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_StaffMembers_WaiterId",
                        column: x => x.WaiterId,
                        principalTable: "StaffMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Payments_StaffMembers_CashierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tips_StaffMembers_StaffMemberId",
                        column: x => x.StaffMemberId,
                        principalTable: "StaffMembers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CafeTables_IsDeleted",
                table: "CafeTables",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_CafeTables_SeatsCount",
                table: "CafeTables",
                column: "SeatsCount");

            migrationBuilder.CreateIndex(
                name: "IX_CafeTables_Status",
                table: "CafeTables",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_RegisteredAt",
                table: "Customers",
                column: "RegisteredAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CreatedByStaffMemberId",
                table: "Orders",
                column: "CreatedByStaffMemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CafeTableId",
                table: "Reservations",
                column: "CafeTableId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_ReservedUntil",
                table: "Reservations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_HireDate",
                table: "StaffMembers",
                column: "HireDate");

            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_IdentityUserId",
                table: "StaffMembers",
                column: "IdentityUserId");

            migrationBuilder.CreateIndex(
                name: "IX_StaffMembers_IsDeleted",
                table: "StaffMembers",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tips_GivenAt",
                table: "Tips",
                column: "GivenAt");

            migrationBuilder.CreateIndex(
                name: "IX_Tips_IsDeleted",
                table: "Tips",
                column: "IsDeleted");
